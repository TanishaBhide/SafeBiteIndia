// SafeBite India — components/results/RegulatoryPanel.tsx
...
export default function RegulatoryPanel({ category, findings, hasLicense, fssaiNumber }: RegulatoryPanelProps) {
  const standard = FSSAI_CATEGORY_STANDARDS[category.toLowerCase()] || FSSAI_CATEGORY_STANDARDS['sauce'];
        ...
        <div className="space-y-4">
          ...
          <div className="bg-slate-50 rounded-2xl p-5 border border-slate-100 space-y-3">
            ...
            <div className="flex items-center gap-1 text-[10px] text-primary hover:underline cursor-pointer">
              View Source: {standard.source} <ExternalLink className="h-2 w-2" />
            </div>
          </div>
        </div>
